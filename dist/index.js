...
`;function u({children:e,href:t,light:n=!1,filled:r=!1,className:o,onClick:a}){return i.createElement("div",{className:"d-flex"},i.createElement(f,{href:t,light:n,filled:r,onClick:a,className:o},e))}const g=a.default.div`
    padding: 2rem 1rem;
    bottom: 0;
    z-index: 9999;
    background: ${l};
