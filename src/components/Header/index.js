            ...
            <Header className={`d-flex w-100${className ? ` ${className}` : ''}`}>
                <div className='container d-flex w-100 justify-content-between align-items-center small-text'>
                    ...
                    <div className='d-flex align-items-center'>
                        {instagram && (
                            <a key={index} className='d-inline-flex icon' href={instagram.link} rel='noopener noreferrer'>
                        ...
                        {youtube && (
                            <a key={index} className='d-inline-flex icon' href={youtube.link} rel='noopener noreferrer'>
